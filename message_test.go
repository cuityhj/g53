...
func TestCompliateMessageFromToWire(t *testing.T) {
	...
	/*
		...
		;; AUTHORITY SECTION:
		knet.cn.	193	IN	NS	gns1.joe.net.
		knet.cn.	193	IN	NS	lns2.joe.biz.
		knet.cn.	193	IN	NS	gns2.joe.net.cn.
		knet.cn.	193	IN	NS	lns1.joe.info.

		;; ADDITIONAL SECTION:
		gns1.joe.net.	9772	IN	A	1.8.152.1
		gns2.joe.net.cn.	1433	IN	A	1.8.153.1

		lns1.joe.info.	1992	IN	A	111.1.33.137
		lns1.joe.info.	1992	IN	A	119.167.233.233
		lns1.joe.info.	1992	IN	A	182.131.23.11
		lns1.joe.info.	1992	IN	A	1.8.101.253
		lns1.joe.info.	1992	IN	AAAA	2401:8d00:4::1

		lns2.joe.biz.	12266	IN	A	119.167.233.235
		lns2.joe.biz.	12266	IN	A	182.131.23.12
		lns2.joe.biz.	12266	IN	A	1.8.101.252
		lns2.joe.biz.	12266	IN	A	111.1.33.138
		lns2.joe.biz.	9375	IN	AAAA	2401:8d00:6::1
	*/
	...
	ns1, _ := NSFromString("gns1.joe.net.")
	ns2, _ := NSFromString("lns2.joe.biz.")
	ns3, _ := NSFromString("gns2.joe.net.cn.")
	ns4, _ := NSFromString("lns1.joe.info.")
	...
	var additional Section
	sn, _ = NameFromString("gns1.joe.net.")
	...
	sn, _ = NameFromString("gns2.joe.net.cn.")
	...
	sn, _ = NameFromString("lns1.joe.info.")
	...
	sn, _ = NameFromString("lns2.joe.biz.")
